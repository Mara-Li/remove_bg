...
export const handleUploadClick = (fileInputRef: React.RefObject<HTMLInputElement>) => {
  fileInputRef.current?.click();
};

export const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, setUploadedImage: React.Dispatch<React.SetStateAction<string | null>>) => {
...
export const handlePaste = (e: ClipboardEvent, setUploadedImage: React.Dispatch<React.SetStateAction<string | null>>) => {
